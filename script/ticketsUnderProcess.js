...
fetch("/ticketsUnderProcessList").then(function (response) {
...
function displayTicket(ticket) {
    ...
    time.innerText = new Date(ticket.createdAt).toLocaleDateString('en-US', {year: 'numeric',month: 'long', day: 'numeric',hour: 'numeric',minute: 'numeric'});
